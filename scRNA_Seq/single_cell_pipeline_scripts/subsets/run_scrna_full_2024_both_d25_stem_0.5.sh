...
#SBATCH -e logs/scrna_full_2024_both_d25_stem_inf_error.%j.%x.txt
#SBATCH -o logs/scrna_full_2024_both_d25_stem_inf_output.%j.%x.txt
...
proj_name="scrna_full_2024_both_d25_stem_0.5"
