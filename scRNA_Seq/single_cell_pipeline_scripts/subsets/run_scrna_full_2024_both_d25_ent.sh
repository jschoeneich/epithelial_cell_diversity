...
#SBATCH -e logs/scrna_full_2024_both_d25_ent_error.%j.%x.txt
#SBATCH -o logs/scrna_full_2024_both_d25_ent_output.%j.%x.txt
...
proj_name="scrna_full_2024_both_d25_ent_v2"
