...
generate_compare_promedi <- function(compare_GO, 
  ...
  df_promedi$Description_trunc <- sapply(df_promedi$Description,
                                         truncate_go_term)
  ...
  df_promedi <- df_promedi %>%
    mutate(p.adjust = ifelse(p.adjust > max_p_promedi, 
                             max_p_promedi, p.adjust)) %>%
...
theme.dp_promedi <- list(
  ...
  scale_color_gradient(
    low = low_color,
    high = high_color,
    limits = c(0, max_p_promedi)  # Skalenlimit analog zu theme.dp_cv
  ),
...
generate_compare_promedi(up_compare_GO, 
                        ...
                        plot_name = glue(NAME,"up_compare_filter"),
                        table_name = glue(NAME,"up_compare_filter"),
                        plot_width = 5,
                        plot_height = 4)
```
...
generate_compare_promedi(down_compare_GO, 
                        ...
                        plot_dir = plots_folder,
                        charts_dir = charts_folder, 
                        plot_name = glue(NAME,"down_compare_filter"),
                        table_name = glue(NAME,"_down_compare_filter"),
                        plot_width = 3.5,
                        plot_height = 3.5
                        )
```
